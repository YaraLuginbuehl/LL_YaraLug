...
def read_bin_file(file_path):
    ...
    # INPUT: 
    # file_path: Path to the binary file containing IMU data

    # OUTPUT:
    # df: DataFrame containing the parsed IMU data with columns for yaw, pitch, roll, magnetometer, accelerometer, and gyroscope data
